...
class Utilisateur extends \UserBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'raisonSociale', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'adresse', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'codePostale', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'ville', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'siret', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'plaques', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'devis', '' . "\0" . 'UserBundle\\Entity\\Utilisateur' . "\0" . 'tel', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
