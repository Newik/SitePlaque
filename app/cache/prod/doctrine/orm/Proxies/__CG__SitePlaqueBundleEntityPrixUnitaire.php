 ...
 */
class PrixUnitaire extends \SitePlaqueBundle\Entity\PrixUnitaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SitePlaqueBundle\\Entity\\PrixUnitaire' . "\0" . 'id', '' . "\0" . 'SitePlaqueBundle\\Entity\\PrixUnitaire' . "\0" . 'libelle', '' . "\0" . 'SitePlaqueBundle\\Entity\\PrixUnitaire' . "\0" . 'prix');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrixUnitaire $proxy) {
